...
class _CameraScreenState extends State<CameraScreen> {
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      home: Scaffold(
        appBar: AppBar(
          title: Center(child: Text('التقاط صورة الأشعة'),)
        ),
        body: Column( crossAxisAlignment: CrossAxisAlignment.stretch,
          mainAxisAlignment: MainAxisAlignment.center,
          children: [
            ElevatedButton(
              child: Text('التقط صورة ',style: TextStyle(fontSize: 18),),
              onPressed: () async {
            ...
            ElevatedButton(
              child: Text('افتح الكاميرا',style: TextStyle(fontSize: 18),),
              onPressed: () async {
            ...
            ElevatedButton(
              ...
              child: Text('حفظ الصورة ',style: TextStyle(fontSize: 18),),
            ),
            ElevatedButton(
              onPressed: () async {
              ...
              child: Text('حفظ الفيديو',style: TextStyle(fontSize: 18),),
            ),
            path != null
                ? Container(
              height: 200,
